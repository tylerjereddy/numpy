...
def _realType(t, default=double):
    if finfo(clongdouble).bits == finfo(cdouble).bits:
        # long double can be the same size as double on some platforms
        _real_types_map[clongdouble] = double
        _real_types_map[longdouble] = double
    return _real_types_map.get(t, default)

def _complexType(t, default=cdouble):
    if finfo(clongdouble).bits == finfo(cdouble).bits:
        _complex_types_map[clongdouble]: cdouble
        _complex_types_map[longdouble]: cdouble
