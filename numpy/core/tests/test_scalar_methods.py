...
class TestAsIntegerRatio(object):
    ...
    @pytest.mark.parametrize("ftype, frac_vals, exp_vals", [
        ...
        (np.double, [0.0, 0.031066908499895136, 0.5214135908877832,
                    ...
                    [0, -801, 51, 194, -653]),
        pytest.param(np.longdouble, [0.0, 0.20492557202724854,
                     0.4277180662199366, 0.9888085019891495,
                     0.9620175814461964],
                     [0, -7400, 14266, -7822, -8721],
                     marks=pytest.mark.xfail(os.name == 'nt',
                           reason='longdouble too small on Windows'))])
